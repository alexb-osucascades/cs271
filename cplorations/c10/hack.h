...
static inline comp_id str_to_compid(const char *s, int *a) {
    ...
    if (strcmp(s, "0") == 0) {
        ...
        *a = 0;
        ...
        id = COMP_D_OR_A;
        *a = 0;
    } else if (strcmp(s, "M") == 0) { //48
        //id = COMP_M;
        id = 48;
        *a = 1;
    } else if (strcmp(s, "!M") == 0) { //49
        //id = COMP_NOT_M;
        id = 49;
        *a = 1;
    } else if (strcmp(s, "-M") == 0) { 
        id = COMP_NEG_M;
        *a = 1;
    } else if (strcmp(s, "M+1") == 0) { // 55
        // id = COMP_M_PLUS_1;
        id = 55;
        *a = 1;
    } else if (strcmp(s, "M-1") == 0) {//50
        //id = COMP_M_MINUS_1;
        id = 50;
        *a = 1;
    } else if (strcmp(s, "D+M") == 0) {//2
        //id = COMP_D_PLUS_M;
        id = 2;
        *a = 1;
    } else if (strcmp(s, "D-M") == 0) {//19
        //id = COMP_D_MINUS_M;
        id = 19;
        *a = 1;
    } else if (strcmp(s, "M-D") == 0) {//7
        //id = COMP_M_MINUS_D;
        id = 7;
        *a = 1;
    } else if (strcmp(s, "D&M") == 0) {//0
        //id = COMP_D_AND_M;
        id = 0;
        *a = 1;
    } else if (strcmp(s, "D|M") == 0) {//21
        //id = COMP_D_OR_M;
        id = 21;
        *a = 1;
    }
